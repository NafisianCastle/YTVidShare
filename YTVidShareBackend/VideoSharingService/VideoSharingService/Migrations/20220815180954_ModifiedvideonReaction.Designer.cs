...
namespace VideoSharingService.Migrations
{
    ...
    [Migration("20220815180954_ModifiedvideonReaction")]
    partial class ModifiedvideonReaction
    {
            ...
            modelBuilder.Entity("VideoSharingService.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2022, 8, 16, 0, 9, 53, 833, DateTimeKind.Local).AddTicks(3127),
